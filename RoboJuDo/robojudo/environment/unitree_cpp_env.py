...
class UnitreeCppEnv(Environment):
    ...
    def emergency_damp(self):
        """
        Parada física de emergencia.

        Deshabilita el envío normal de acciones de la política
        y solicita damping al controlador C++.
        """
        logger.critical(
            "Emergency damping requested."
        )
    ...
    def shutdown(self):
        ...
        Importante: shutdown sigue significando damping.
        No debe llamarse al finalizar normalmente un baile.
        """
        self.emergency_damp()
